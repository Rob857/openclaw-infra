...
- **Mission Control**: Optional OpenClaw dashboard on the VPS, exposed via Tailscale Serve at `/mission-control`
...
By default, Mission Control is exposed only inside your tailnet via Tailscale Serve at `/mission-control`.
